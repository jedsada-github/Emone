 ...
 * @retval int32_t
 */
int32_t WiMOD_DevMgmt_Msg_Req(uint8_t msg_id, const uint8_t *val, uint16_t len)
{
 ...
 * @retval int32_t
 */
int32_t WiMOD_LoRaWAN_Msg_Req(uint8_t msg_id, const uint8_t *val, uint16_t len)
{
 ...
 * @retval int32_t
 */
int32_t WiMOD_LoRaWAN_SetCustomConfig(const uint8_t val)
{
 ...
 * @retval int32_t
 */
int32_t WiMOD_LoRaWAN_SetOPMODE(const uint8_t val)
{
    if (val > 1U)
    {
        return (-1);
 ...
 * @retval int32_t
 */
int32_t WiMOD_LoRaWAN_SetRTCAlarm(const uint8_t *alarm)
{
 ...
 * @retval int32_t
 */
int32_t WiMOD_LoRaWAN_SetRTC(const uint32_t *time)
{
    return WiMOD_DevMgmt_Msg_Req(DEVMGMT_MSG_SET_RTC_REQ, (const uint8_t *) time, 4U);
}
 ...
 * @retval int32_t
 */
int32_t WiMOD_LoRaWAN_SetLinkADR(const uint8_t *payload)
{
 ...
 * @retval int32_t
 */
int32_t WiMOD_LoRaWAN_SetMAC_CMD(const uint8_t *payload)
{
 ...
 * @retval int32_t
 */
int32_t WiMOD_LoRaWAN_SetJoinParameters(const uint8_t *payload)
{
...
int32_t WiMOD_LoRaWAN_SendURadioData(
        ...
        uint8_t len)   /* Length of application payload */
{
    uint8_t payload[WIMOD_HCI_MSG_PAYLOAD_SIZE] = { 0U };

    /* 1. Check length */
    if (len > (WIMOD_HCI_MSG_PAYLOAD_SIZE - 1U))
    {
        /* Overflow error */
        return (-1);
    }
    ...
    return WiMOD_LoRaWAN_Msg_Req(LORAWAN_MSG_SEND_UDATA_REQ, payload, 1U + len);
}
...
int32_t WiMOD_LoRaWAN_SendCRadioData(
        ...
        uint8_t len) /* Length of application data */
{
    uint8_t payload[WIMOD_HCI_MSG_PAYLOAD_SIZE] = { 0U };
    ...
    return WiMOD_LoRaWAN_Msg_Req(LORAWAN_MSG_SEND_CDATA_REQ, payload, 1U + len);
}
...
static void WiMOD_LoRaWAN_Process_DevMgmt_Message(TWiMOD_HCI_Message *rxMessage)
{
    switch (rxMessage->MsgID)
    {
        ...
        default:
            WiMOD_SERIAL_Printf("Unhandled DeviceMgmt message received - MsgID: 0x""%02X\n\r",
...
static void WiMOD_LoRaWAN_DevMgmt_Get_OPMODE_Rsp(TWiMOD_HCI_Message *rxMessage)
{
    ...
    {
        WiMOD_SERIAL_Printf("OPMODE Set: 0x");
        WiMOD_SERIAL_Printf((const char *)num2hex((uint32_t)rxMessage->Payload[1], BYTE_F));
        WiMOD_SERIAL_Printf("\n\r");
    }
}
...
static void WiMOD_LoRaWAN_DevMgmt_Get_RTC_ALARM_Rsp(TWiMOD_HCI_Message *rxMessage)
{
    ...
    if (rxMessage->Payload[0U] == DEVMGMT_STATUS_OK)
    {
        WiMOD_SERIAL_Printf("RTC ALARM Set: 0x");
        WiMOD_SERIAL_Printf((const char *)num2hex((uint32_t)rxMessage->Payload[1U], BYTE_F));
        WiMOD_SERIAL_Printf("\n\r");

        WiMOD_SERIAL_Printf("RTC ALARM Daily: 0x");
        WiMOD_SERIAL_Printf((const char *)num2hex((uint32_t)rxMessage->Payload[2U], BYTE_F));
        WiMOD_SERIAL_Printf("\n\r");

        memcpy((uint8_t *)&help, &rxMessage->Payload[3U], 3U);
        WiMOD_SERIAL_Printf("RTC ALARM Time: [");
        num2str((help & 0xFFU), str); /* Hour */
        WiMOD_SERIAL_Printf((const char *)str);
        WiMOD_SERIAL_Printf(":");
...
static void WiMOD_LoRaWAN_DevMgmt_DeviceStatus_Rsp(TWiMOD_HCI_Message *rxMessage)
{
    ...
    if (rxMessage->Payload[0U] == DEVMGMT_STATUS_OK)
    {
        ...
        WiMOD_SERIAL_Printf("System Tick Resolution: ");
        WiMOD_SERIAL_Printf((const char *)str);
        WiMOD_SERIAL_Printf(" ms\n\r");

        memcpy((uint8_t *)&help, &rxMessage->Payload[2U], 4U);
        num2str(help, str);
        WiMOD_SERIAL_Printf("System Tick: ");
        WiMOD_SERIAL_Printf((const char *)str);
        WiMOD_SERIAL_Printf("\n\r");

        memcpy((uint8_t *)&help, &rxMessage->Payload[6U], 4U);
        WiMOD_SERIAL_Printf("Target Time: ");
        num2str(((help & 0xFC000000U) >> 26U) + 2000U, str); /* Year */
        WiMOD_SERIAL_Printf((const char *)str);
        WiMOD_SERIAL_Printf("-");
        num2str(((help & 0xF000U) >> 12U), str); /* Months */
...
static void WiMOD_LoRaWAN_DevMgmt_DeviceInfo_Rsp(TWiMOD_HCI_Message *rxMessage)
{
    ...
    if (rxMessage->Payload[0U] == DEVMGMT_STATUS_OK)
    {
        ...
        memcpy((uint8_t *)&help, &rxMessage->Payload[2U], 4U);
        WiMOD_SERIAL_Printf("Device address: 0x");
        WiMOD_SERIAL_Printf((const char *)num2hex((uint32_t)help, DOUBLEWORD_F));
        WiMOD_SERIAL_Printf("\n\r");

        memcpy((uint8_t *)&help, &rxMessage->Payload[6U], 4U);
        WiMOD_SERIAL_Printf("Device ID: 0x");
        WiMOD_SERIAL_Printf((const char *)num2hex((uint32_t)help, DOUBLEWORD_F));
        WiMOD_SERIAL_Printf("(");
        num2str(help, str);
        WiMOD_SERIAL_Printf((const char *)str);
...
static void WiMOD_LoRaWAN_DevMgmt_FirmwareVersion_Rsp(TWiMOD_HCI_Message *rxMessage)
{
    ...
    if (rxMessage->Payload[0U] == DEVMGMT_STATUS_OK)
    {
        ...
        if (rxMessage->Length > 15U)
        {
            ...
            WiMOD_SERIAL_Printf("firmware-content: %s\n\r", &rxMessage->Payload[15U]);
        }
    }
}
...
static void WiMOD_LoRaWAN_Process_LoRaWAN_Message(TWiMOD_HCI_Message *rxMessage)
{
    switch (rxMessage->MsgID)
    {
        ...
        case LORAWAN_MSG_RECV_NODATA_IND:
            WiMOD_SERIAL_Printf("no data received indication\n\r");
            break;
        ...
        case LORAWAN_MSG_SET_LINKADRREQ_CONFIG_RSP:
            ...
            break;
        default:
            WiMOD_SERIAL_Printf("Unhandled LoRaWAN SAP message ""received - MsgID : 0x");
            WiMOD_SERIAL_Printf((const char *)num2hex(rxMessage->MsgID, BYTE_F));
            WiMOD_SERIAL_Printf("\n\r");
            break;
    }
}
...
static void WiMOD_LoRaWAN_Process_C_DATA_TxIndication(TWiMOD_HCI_Message *rxMessage)
{
    ...
    {
        WiMOD_SERIAL_Printf("c data tx event : radio packet sent\n\r");
    }
    else if (rxMessage->Payload[0U] == 0x01U) /* Channel info attached ? */
    {
        WiMOD_SERIAL_Printf("c data tx event : radio packet sent with tx channel info attached\n\r");
        WiMOD_SERIAL_Printf("c data tx event ChIdx %d\n\r", (int)rxMessage->Payload[1U]);
        WiMOD_SERIAL_Printf("\tDR: %ld\n\r", (int32_t)rxMessage->Payload[2U]);
        WiMOD_SERIAL_Printf("\tNum: %ld\n\r", (int32_t)rxMessage->Payload[3U]);
        WiMOD_SERIAL_Printf("\tPower(dBm): %ld\n\r", (int32_t)rxMessage->Payload[4U]);
        WiMOD_SERIAL_Printf("\tAirtime (ms): %ln\n\r", (uint32_t *)&rxMessage->Payload[5U]);
    }
    else if (rxMessage->Payload[0U] & 0x02U)
    {
        WiMOD_SERIAL_Printf("error, maximum number of retransmissions reached\n\r");
    }
    else if (rxMessage->Payload[0U] & 0x04U)
    {
        WiMOD_SERIAL_Printf("maximum payload size exceeded for current data rate\n\r");
    }
    else
    {
        WiMOD_SERIAL_Printf("c data tx event - Status : error\n\r");
    }
}
...
static void WiMOD_LoRaWAN_Process_U_DATA_TxIndication(TWiMOD_HCI_Message *rxMessage)
{
    if (rxMessage->Payload[0U] == 0x00U)
    {
        WiMOD_SERIAL_Printf("u data tx event : radio packet sent\n\r");
    }
    else if (rxMessage->Payload[0U] == 0x01U) /* Channel info attached ? */
    {
        WiMOD_SERIAL_Printf("u data tx event : radio packet sent with "
                "tx channel info ""attached\n\r");
        WiMOD_SERIAL_Printf("u data tx event ChIdx %ld\n\r", (int32_t)rxMessage->Payload[1U]);
        WiMOD_SERIAL_Printf("\tDR: %ld\n\r", (int32_t)rxMessage->Payload[2U]);
        WiMOD_SERIAL_Printf("\tNum: %ld\n\r", (int32_t)rxMessage->Payload[3U]);
        WiMOD_SERIAL_Printf("\tPower(dBm): %ld\n\r", (int32_t)rxMessage->Payload[4U]);
        WiMOD_SERIAL_Printf("\tAirtime (ms): %ln\n\r", (uint32_t *)&rxMessage->Payload[5U]);
    ...
    {
        WiMOD_SERIAL_Printf("u data tx event - Status : error\n\r");
    }
}
...
static void WiMOD_LoRaWAN_Process_JoinTxIndication(TWiMOD_HCI_Message *rxMessage)
{
    if (rxMessage->Payload[0U] == 0x00U)
    {
        WiMOD_SERIAL_Printf("join tx event - Status : ok\n\r");
    }
    else if (rxMessage->Payload[0U] == 0x01U) /* Channel info attached ? */
    {
        WiMOD_SERIAL_Printf("join tx event:%d, ChnIdx:%d, DR:%d - Status : ok\n\r",
    ...
    {
        WiMOD_SERIAL_Printf("join tx event - Status : error\n\r");
    }
}
...
void WiMOD_LoRaWAN_Process_JoinNetworkIndication(TWiMOD_HCI_Message *rxMessage)
{
    ...
    if (rxMessage->Payload[0U] == 0x00U)
    {
        ...
        WiMOD_SERIAL_Printf("join network accept event - DeviceAddress:0x%08lX\n\r", address);
    }
    else if (rxMessage->Payload[0U] == 0x01U)
    {
        address = MAKELONG(MAKEWORD(rxMessage->Payload[1U],
                           ...
                           MAKEWORD(rxMessage->Payload[3U],
                           rxMessage->Payload[4U]));
        WiMOD_SERIAL_Printf("join network accept event - "
    ...
    {
        WiMOD_SERIAL_Printf("join network timeout event\n\r");
    }
}
...
void WiMOD_LoRaWAN_Process_U_DataRxIndication(TWiMOD_HCI_Message *rxMessage)
{
    ...
    {
        WiMOD_SERIAL_Printf("U-Data rx event: port:0x");
        WiMOD_SERIAL_Printf((const char *)num2hex(rxMessage->Payload[1U], BYTE_F));
        WiMOD_SERIAL_Printf("\n\rapp-payload: 0x");
        for (i = 1U; i < payloadSize; i++)
        {
            WiMOD_SERIAL_Printf((const char *)num2hex(rxMessage->Payload[1U + i], BYTE_F));
        }
        WiMOD_SERIAL_Printf("\n\r");
    }
    ...
    {
        WiMOD_SERIAL_Printf("ack for uplink packet:yes\n\r");
    }
    else
    {
        WiMOD_SERIAL_Printf("ack for uplink packet:no\n\r");
    }

    if (rxMessage->Payload[0U] & 0x04U)
    {
        WiMOD_SERIAL_Printf("frame pending:yes\n\r");
    }
    else
    {
        WiMOD_SERIAL_Printf("frame pending:no\n\r");
    }
    ...
    if (rxMessage->Payload[0U] & 0x01U)
    {
        ...
        WiMOD_SERIAL_Printf("ChnIdx:%d, DR:%d, RSSI:%d, SNR:%d, RxSlot:%d\n\r",
                   (uint8_t)rxInfo[0U],
                   (uint8_t)rxInfo[1U],
                   (uint8_t)rxInfo[2U],
                   (uint8_t)rxInfo[3U],
...
void WiMOD_LoRaWAN_Process_C_DataRxIndication(TWiMOD_HCI_Message *rxMessage)
{
    ...
    if (payloadSize >= 0x01)
    {
        WiMOD_SERIAL_Printf("C-Data rx event: port:0x%02X\n\rapp-payload:", rxMessage->Payload[1U]);
        for (i = 1U; i < payloadSize; i++)
        {
            WiMOD_SERIAL_Printf((const char *)num2hex(rxMessage->Payload[1U + i], BYTE_F));
        }
...
static void WiMOD_LoRaWAN_Process_Get_LINK_ADR_RSP(TWiMOD_HCI_Message *rxMessage)
{
    ...
    if (rxMessage->Payload[0U] == LORAWAN_STATUS_OK)
    {
        WiMOD_SERIAL_Printf("LinkADRReq Option: ");
        switch (rxMessage->Payload[1U])
        {
            case 0x00U:
                WiMOD_SERIAL_Printf("LoRaWAN v1.0.2");
                break;
            case 0x01U:
                WiMOD_SERIAL_Printf("Semtech proposal");
                break;
            case 0x02U:
                WiMOD_SERIAL_Printf("KPN/Actility proposal");
                break;
            default:
                WiMOD_SERIAL_Printf("Unknown proposal");
                break;
        }
        WiMOD_SERIAL_Printf("\n\r");
    }
...
static void WiMOD_LoRaWAN_Process_Get_Network_Status_RSP(TWiMOD_HCI_Message *rxMessage)
{
    ...
    if (rxMessage->Payload[0U] == LORAWAN_STATUS_OK)
    {
        WiMOD_SERIAL_Printf("Network Status: 0x%02X\n\r", rxMessage->Payload[1U]);

        switch (rxMessage->Payload[1])
        {
            case 0x01U:
                WiMOD_SERIAL_Printf("active (ABP)\n\r");
                break;
            case 0x02U:
                WiMOD_SERIAL_Printf("active (OTAA)\n\r");
                break;
            case 0x03U:
                WiMOD_SERIAL_Printf("joining (OTAA)\n\r");
                break;
            default:
                WiMOD_SERIAL_Printf("device inactive\n\r");
                return;
        }
        ...
        WiMOD_SERIAL_Printf("\tDR: ");
        WiMOD_SERIAL_Printf((const char *)str);
        WiMOD_SERIAL_Printf("\n\r");

        num2str(rxMessage->Payload[7U], str);
        WiMOD_SERIAL_Printf("\tPower: ");
        WiMOD_SERIAL_Printf((const char *)str);
        WiMOD_SERIAL_Printf("dBm\n\r");

        num2str(rxMessage->Payload[8U], str);
        WiMOD_SERIAL_Printf("\tMax. payload size: ");
        WiMOD_SERIAL_Printf((const char *)str);
        WiMOD_SERIAL_Printf("\n\r");
    }
}
...
static void WiMOD_LoRaWAN_Process_Get_Custom_CFG_RSP(TWiMOD_HCI_Message *rxMessage)
{
    ...
    if (rxMessage->Payload[0U] == LORAWAN_STATUS_OK)
    {
        WiMOD_SERIAL_Printf("RF Gain: %d dBd\n\r", (int)rxMessage->Payload[1U]);
    }
}
...
static void WiMOD_LoRaWAN_Process_Get_Device_EUI_RSP(TWiMOD_HCI_Message *rxMessage)
{
    ...
    if (rxMessage->Payload[0U] == LORAWAN_STATUS_OK)
    {
        WiMOD_SERIAL_Printf("Device EUI: \n\r");
        for (i = 1U; i < rxMessage->Length; ++i)
        {
            WiMOD_SERIAL_Printf(" %02X", rxMessage->Payload[i]);
        }
        WiMOD_SERIAL_Printf("\n\r");
    }
}
...
static void WiMOD_LoRaWAN_Process_Get_Support_Band_RSP(TWiMOD_HCI_Message *rxMessage)
{
    ...
    if (rxMessage->Payload[0U] == LORAWAN_STATUS_OK)
    {
        ...
        {
            WiMOD_SERIAL_Printf("Band Idx: %d\n\r", rxMessage->Payload[i]);
            WiMOD_SERIAL_Printf("Max. EIRP: %d dBm\n\r", rxMessage->Payload[1 + i]);
        }
    }
}
...
static void WiMOD_LoRaWAN_Process_Set_RSTACK_RSP(TWiMOD_HCI_Message *rxMessage)
{
    ...
    if (rxMessage->Payload[0U] == LORAWAN_STATUS_WRONG_PARAMETER)
    {
        if (rxMessage->Payload[1U] & 0x01U)
        {
            ...
            WiMOD_SERIAL_Printf("Wrong Data Rate\n\r");
        }
        if (rxMessage->Payload[1U] & 0x02U)
        {
            WiMOD_SERIAL_Printf("Wrong TX Power Level\n\r");
        }
        if (rxMessage->Payload[1U] & 0x20U)
        {
            WiMOD_SERIAL_Printf("Wrong Band Index\n\r");
        }
    }
}
...
static void WiMOD_LoRaWAN_Process_Get_RSTACK_RSP(TWiMOD_HCI_Message *rxMessage)
{
    ...
    WiMOD_SERIAL_Printf("Data Rate: ");
    num2str(rxMessage->Payload[1U], str);
    WiMOD_SERIAL_Printf((const char *)str);
    WiMOD_SERIAL_Printf("\n\r");

    WiMOD_SERIAL_Printf("TX Power Level (EIRP): ");
    num2str(rxMessage->Payload[2U], str);
    WiMOD_SERIAL_Printf((const char *)str);
    WiMOD_SERIAL_Printf("\n\r");

    WiMOD_SERIAL_Printf("Adaptive DR: ");
    if (rxMessage->Payload[3U] & 0x01U)
    {
        WiMOD_SERIAL_Printf("enable\n\r");
    }
    else
    {
        WiMOD_SERIAL_Printf("disable\n\r");
    }
    WiMOD_SERIAL_Printf("Duty Cycle: ");
    ...
    WiMOD_SERIAL_Printf("Class : ");
    if (rxMessage->Payload[3U] & 0x04U)
    {
        WiMOD_SERIAL_Printf("C\n\r");
    }
    else
    {
        WiMOD_SERIAL_Printf("A\n\r");
    }
    WiMOD_SERIAL_Printf("RF format : ");
    if (rxMessage->Payload[3U] & 0x40U)
    {
        WiMOD_SERIAL_Printf("extended\n\r");
    }
    else
    {
        WiMOD_SERIAL_Printf("standard\n\r");
    }
    WiMOD_SERIAL_Printf("MAC forwarding : ");
    ...
    WiMOD_SERIAL_Printf("Power Saving Mode: ");
    if (rxMessage->Payload[4U] & 0x01U)
    {
        WiMOD_SERIAL_Printf("automatic\n\r");
    }
    else
    {
        WiMOD_SERIAL_Printf("off\n\r");
    }

    WiMOD_SERIAL_Printf("Retransmissions: ");
    num2str(rxMessage->Payload[5U], str);
    WiMOD_SERIAL_Printf((const char *)str);
    WiMOD_SERIAL_Printf("\n\r");

    WiMOD_SERIAL_Printf("BandIdx: ");
    num2str(rxMessage->Payload[6U], str);
    WiMOD_SERIAL_Printf((const char *)str);
    WiMOD_SERIAL_Printf("\n\r");

    WiMOD_SERIAL_Printf("MAC length: ");
    num2str(rxMessage->Payload[7U], str);
    WiMOD_SERIAL_Printf((const char *)str);
    WiMOD_SERIAL_Printf("\n\r");
}
...
static void WiMOD_LoRaWAN_Process_MAC_CMDRxIndication(TWiMOD_HCI_Message *rxMessage)
{
    ...
    if (payloadSize >= 0x01U)
    {
        WiMOD_SERIAL_Printf("MAC rx event:\n\rmac-payload: 0x");
        ...
        const TIDString *statusTable, uint8_t statusID)
{
    while (statusTable->String)
    {
        ...
        {
            WiMOD_SERIAL_Printf(string);
            WiMOD_SERIAL_Printf(" - Status(0x");
            WiMOD_SERIAL_Printf((const char *)num2hex(statusID, BYTE_F));
            WiMOD_SERIAL_Printf(") ");
            WiMOD_SERIAL_Printf(statusTable->String);
            WiMOD_SERIAL_Printf("\n\r");
            return;
        }
