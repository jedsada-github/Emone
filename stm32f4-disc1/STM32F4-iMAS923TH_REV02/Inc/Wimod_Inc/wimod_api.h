...
#ifndef __WIMOD_API_H
#define __WIMOD_API_H
...
int32_t WiMOD_LoRaWAN_SendURadioData(uint8_t port, uint8_t *data, uint8_t len);
int32_t WiMOD_LoRaWAN_SendCRadioData(uint8_t port, uint8_t *data, uint8_t len);
